...
import greenstand from "../../images/greenstand.jpeg"
import raysecur from "../../images/Ray.jpeg"
import qualcomm from "../../images/QQ.png"
import nit from "../../images/nitwcopy.png"
import abs from "../../images/a.png"
            ...
            <div className="flex flex-row-reverse mt-10">
              ...
              <div className="w-3/4 m-2 text-white bg-lightblack p-8 rounded-xl">
                <h1 className="text-4xl font-bold">
                  ...
                  Machine Learning Engineer ( Part Time )</h1>
                  <h1 className="text-1xl">March 2024 - Present</h1>
                <p className="mt-5 opacity-70">
                  Data Engineering | Machine Learning | Computer Vision
                </p>
              </div>
              <div className="w-2/4 rounded-xl overflow-hidden m-2">
                <img src={greenstand}></img>
              </div>
            </div>
            ...
            <div className="flex flex-row-reverse mt-10">
              ...
              <div className="w-3/4 m-2 text-white bg-lightblack p-8 rounded-xl">
                ...
                <h1 className="text-4xl font-bold">
                  ...
                  <h1 className="text-2xl">
                  Machine Learning Engineer Intern</h1>
                  <h1 className="text-1xl">January 2023 - Aug 2023</h1>
                <p className="mt-5 opacity-70">
                  Data Engineering | Data Analysis | Computer Vision | LLM | Machine | Cloud Computation
                </p>
              </div>
              <div className="w-2/4 rounded-xl overflow-hidden m-2">
             <img src={raysecur}></img>
              </div>
            ...
            <div className="flex flex-row-reverse mt-10">
              ...
              <div className="w-3/4 m-2 text-white bg-lightblack p-8 rounded-xl">
                ...
                <h1 className="text-4xl font-bold">
                  ...
                  <h1 className="text-2xl">
                  Senior Software Developer</h1>
                  <h1 className="text-1xl">July 2017 - Feb 2021</h1>
                <p className="mt-5 opacity-70">
                  Data Analysis | Machine Learning | Automation | Data Engineering | Project Management | Team Leader
                </p>
              </div>
              <div className="w-2/4 rounded-xl overflow-hidden m-2">
            ...
            <div className="flex flex-row-reverse mt-10">
              ...
              <div className="w-3/4 m-2 text-white bg-lightblack p-8 rounded-xl">
                ...
                <h1 className="text-4xl font-bold">
                  ...
                  <h1 className="text-1xl">July 2015 - June 2017</h1>
                <p className="mt-5 opacity-70">
